# `SpFFT_jll.jl` (v1.0.6+0)

[![deps](https://juliahub.com/docs/SpFFT_jll/deps.svg)](https://juliahub.com/ui/Packages/SpFFT_jll/O7GEv?page=2)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/331a2edbd3bcea1fd24b28e8ff3328237d65e8ce/S/SpFFT/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `SpFFT_jll.jl` have been built from these sources:

* git repository: https://github.com/eth-cscs/SpFFT/ (revision: `aa6653f044dc8f6dbf5dc7befe45db7ce353938e`)

## Platforms

`SpFFT_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `SpFFT_jll.jl`:
